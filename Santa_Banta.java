...
public class Santa_Banta 
{
    ...
    public static int helpSanta (int n, int m, int g[][]) 
    {
        ...
        if(max==1) 
            return -1; //In case no of connections is zero, print "-1". 
	...
	{
		int vertex = 10;
		int g[][] = {{1,2},{2,3},{3,4},{4,5},{6,7},{9,10}};
		System.out.println(helpSanta(vertex,g.length,g));
	}
}